...
class CalendarProjectsList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      DailyEvents: [],
  ...
  componentDidMount() {
    const { projectDailyEvents } = this.props;
    this.setState({
      DailyEvents: projectDailyEvents,
    });
  }
...
export default connect(null, { removeCalendar })(CalendarProjectsList);
